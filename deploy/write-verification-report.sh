...
json_report="${SCRIPT_DIR}/verification-report.json"
txt_report="${SCRIPT_DIR}/verification-report.txt"
...
- transcoding absent / not configured: $( [[ "${SMOKE_TRANSCODING_ENABLED}" == "true" ]] && echo "false" || echo "true" )
