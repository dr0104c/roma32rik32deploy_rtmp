...
record_result "${SMOKE_ADMIN_AUTH_OK}" "admin_auth_ok"
record_result "${SMOKE_ADMIN_UI_OK}" "admin_ui_ok"
record_result "${SMOKE_USER_MODERATION_OK}" "user_moderation_ok"
record_result "${SMOKE_GROUP_ACL_OK}" "group_acl_ok"
record_info "legacy_admin_secret_mode" "${SMOKE_LEGACY_ADMIN_SECRET_MODE}"
...

{
  ...
  printf 'VERIFY_LEGACY_ADMIN_SECRET_MODE=%q\n' "${SMOKE_LEGACY_ADMIN_SECRET_MODE}"
